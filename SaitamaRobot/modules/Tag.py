...
UNTAG_ME_HANDLER = DisableAbleCommandHandler("untagme", untagme, filters=Filters.group)
TAG_ME_HANDLER = DisableAbleCommandHandler("tagme", tagme, filters=Filters.group)
